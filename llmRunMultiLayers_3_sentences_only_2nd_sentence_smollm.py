...
dfs[layer]['last_token'] = pd.Series(dtype=object)
...
for dataset_to_use in list_of_datasets:
    ...
    for i, row in df.iterrows():
        ...
        token = tokenizer.convert_ids_to_tokens(token_ids[second_token].item())
    ...
    dfs[layer].to_csv("embeddings_3_sentences\\3_sentence_only_2nd_" +  dataset_to_use +"_Smollm_1.7B_" + str(abs(layer)) + ".csv", index=False)
