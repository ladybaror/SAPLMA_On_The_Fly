...
'''for dataset_name in dataset_names:
    ...
    datasets.append(pd.read_csv("is_it_capitals_pairs_SmolLM1.7B_12_rmv_period.csv", encoding='latin1'))
'''
results = []
for i in range(len(dataset_names)):
    test_df = datasets.append(pd.read_csv("is_it_capitals_pairs_SmolLM1.7B_12_rmv_period.csv", encoding='latin1'))
    ...
    for j in range(num_of_runs):
        ...
        #model.save("h5\\classifier_"+dataset_names[i]+"_"+str(j)+"_.h5")
